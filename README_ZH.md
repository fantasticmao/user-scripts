...
|                                                                               | 脚本名称        | 功能描述                                 | 链接                                                                                                                                                                                                       |
| ----------------------------------------------------------------------------- | --------------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <img src="https://i.loli.net/2021/03/30/ULV9XunaHesqGIR.png" height="16px" /> | github-nickname | 在 GitHub 动态页和个人主页为用户添加昵称 | [首选](https://rawgithub.fantasticmao.cn/user-scripts/refs/heads/main/github-nickname.user.js) [备用](https://raw.githubusercontent.com/fantasticmao/user-scripts/refs/heads/main/github-nickname.user.js) |
