...
|                                                                               | 脚本名称        | 功能描述                                 | 链接                                                                       |
| ----------------------------------------------------------------------------- | --------------- | ---------------------------------------- | -------------------------------------------------------------------------- |
| <img src="https://i.loli.net/2021/03/30/ULV9XunaHesqGIR.png" height="16px" /> | github-nickname | 在 GitHub 动态页和个人主页为用户添加昵称 | [Greasy Fork](https://greasyfork.org/zh-CN/scripts/577748-github-nickname) |
